...
class WorkModel(models.Model):
    ...
    type_work = models.CharField(verbose_name='Тип работ',
                                 choices=TYPE_ROUTE_CHOICE,
                                 max_length=50)

    polygon = models.ForeignKey(to=Polygon,
                                on_delete=models.CASCADE,
                                related_name='work_polygon',
                                verbose_name='Территория работ',
                                blank=True,)
    polyline = models.ForeignKey(to=Polyline,
                                 on_delete=models.CASCADE,
    ...
    executor = models.ForeignKey(
        to=UserProfile,
        limit_choices_to={'available_for_work': True, 'user_status': UserProfile.WORKER},
